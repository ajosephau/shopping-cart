...
class TestStepOne(unittest.TestCase):
    ...
    def test_main_scenario(self):
        ...
        self.assertEqual(shopping_cart.num_items, 5, "Incorrect number of items in cart")
        self.assertDictEqual(shopping_cart.products, {product_dove_soap: 5}, "Cart is incorrect")
